    ...
    <main className="fh-shell">
      <header className="fh-nav">
        <div className="fh-container fh-nav-inner">
          ...
          <button className="fh-nav-cta" type="button" onClick={() => scrollToId("get-started")}>
          ...
          {mobileOpen && (
            <div className="absolute right-4 top-[66px] z-50 flex w-[calc(100%-32px)] flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl sm:hidden">
              ...
              <button className="fh-primary-btn mt-1 w-full" type="button" onClick={() => { setMobileOpen(false); scrollToId("get-started"); }}>Join the waitlist <ArrowRight size={15} /></button>
            </div>
          )}
        </div>
      </header>
        ...
        <div className="fh-container fh-hero-grid">
          <div className="fh-hero-copy fh-fade-in">
            ...
            <div className="fh-hero-actions">
              <button className="fh-primary-btn" type="button" onClick={() => scrollToId("services")}>Explore what’s available <ArrowRight size={16} /></button>
        ...
        <div className="fh-container">
          ...
          <div className="fh-service-grid">
            <article className="fh-service-card bike">
              ...
              <div className="fh-service-footer"><span className="fh-status-pill">Ready to roll</span><button className="fh-service-link" type="button" onClick={() => scrollToId("pricing")}>See bike plans <ArrowRight size={14} /></button></div>
            </article>
